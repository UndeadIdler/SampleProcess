<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="副本 PurviewMgmt.aspx.cs" Inherits="BaseData_PasswordMgmt" Title="Untitled Page" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <asp:LinkButton ID="lbtn_xk" runat="server" onclick="lbtn_xk_Click" Text="+分析员角色设定"></asp:LinkButton></td></tr>
                    <tr><td style="width:20%"> <asp:Label ID="lbl_a" CssClass="mLabel" Text="A角"  runat="server"></asp:Label></td>
                        <td><asp:CheckBoxList ID="cbl_a" runat="server" RepeatColumns="8" RepeatDirection="Horizontal" ></asp:CheckBoxList></td></tr>
                     <tr><td style="width:20%"> <asp:Label ID="lbl_b" CssClass="mLabel" Text="B角"  runat="server"></asp:Label> </td>
                         <td><asp:CheckBoxList ID="cbl_b" runat="server" RepeatColumns="8" RepeatDirection="Horizontal" ></asp:CheckBoxList>  </td></tr>
                ...
                <asp:LinkButton ID="btn_a_add" runat="server" onclick="btn_a_add_OnClick" Text="+分析员A角设定"></asp:LinkButton>
                    <asp:Repeater ID="Repeater_A" runat="server">
                       ...
                       <tr><td align="left">
                        ...
                        <tr><td colspan="2">
                           <asp:CheckBoxList runat="server" ID="cbl_ItemlistA"  RepeatColumns="8" RepeatDirection="Horizontal"></asp:CheckBoxList>
