<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true" CodeFile="DrawList.aspx.cs" Inherits="Reports_DrawList" Title="每日样品完成量" %>
...
code+= "<center>";
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="container">
                <tbody> <tr>              
                        ...
                        <td class="querytitleList"  style="width: 150px">                            
                        </td><td  width="80px" style="text-align:center;">
                           <asp:Label ID="Label3" runat="server"  Text="样品编号"></asp:Label>
                        </td>
                    <td><asp:TextBox ID="txt_sampleID" runat="server" CssClass="mTextBox" style="text-align:center;vertical-align:middle"  Width="85px"></asp:TextBox></td>
    ...
    <asp:GridView ID="grdvw_List" CssClass="mGridView" runat="server"  
