<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true" CodeFile="SampleDayAccess1.aspx.cs" Inherits="Reports_SampleDayAccess1" Title="每日样品接收量" %>
...
.Freezing 
   ...
   top:expression(this.offsetParent.scrollTop-25); 
   height:50px;  
   z-index: 10;
   }
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="container">
             ...
             <div id="dayin" align="center"  style="position:relative;overflow-y: scroll;  height: 580px;width:900px" >   
