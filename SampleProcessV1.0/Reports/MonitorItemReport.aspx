<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="MonitorItemReport.aspx.cs" Inherits="Reports_MonitorItemReport" Title="报告装订" %>
            ...
            <table style="border-right: 2px groove; border-top: 2px groove; border-left: 2px groove;
                ...
                <tbody>
                    <tr>
                        ...
                        </td> <td style="width: 48px" class="float_Middle">
                            </td>
                        <td style="width:120px;text-align: right" class="titleList" >
                           
                                <asp:Label ID="Label15" runat="server" Text="样品状态"></asp:Label>
                        ...
                        <td class="ctrlList"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="ctrlList">
                                                ...
                                                <asp:DropDownList ID="txt_item" runat="server" Width="156px">
                                                </asp:DropDownList>
                                            </td>
                                            <td class="Middle">
                                            </td>
                                            ...
                                            <td class="ctrlList" style="width: 223px">
                                                <%-- <asp:TextBox ID="txt_type" runat="server" Width="156px"></asp:TextBox>--%>
                        ...
                        <td style="width:120px;text-align: right" class="titleList" >
                                ...
                                <asp:Label ID="Label18" runat="server" Text="委托单位"></asp:Label>
                            
                        </td>
                        <td class="ctrlList">
                           
                            <asp:DropDownList id="drop_client" runat="server" Width="156px"></asp:DropDownList>
                        </td>
                        <td class="Middle">
                        </td>
                        <td style="width:120px;text-align: right" class="titleList" >
                        ...
                        <td></td><td  class="Middle">
                                ...
                                <asp:Panel ID="Panel7" BackColor="#F5F9FF" runat="server" Width="800px" ForeColor= "#2292DD" Height="50px"
                                    Font-Size="X-Small" GroupingText="按接样时间">
                                    <table class=" container">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 164px;">
                                                    <asp:TextBox ID="txt_QueryTime" runat="server" Width="156px"></asp:TextBox>
                                                </td>
                                                <td class="Middle">
                                                </td>
                                                <td style="width: 110px; text-align: right" class="titleList">
                                                    <asp:Label ID="Label17" runat="server" Text="结束时间"></asp:Label>
                                                </td>
                                                <td style="text-align: left;">
                                                    <asp:TextBox ID="txt_QueryEndTime" runat="server" Height="21px" Width="156px"></asp:TextBox>
                                                </td>
                                ...
                                <asp:Panel ID="Panel1" BackColor="#F5F9FF" runat="server" Width="800px" ForeColor= "#2292DD" Height="50px"
                                    Font-Size="X-Small" GroupingText="按分析报告完成时间">
                                    <table class=" container">
                                        <tbody>
                                            <tr>
                                                <td style="width: 115px; text-align: right" class="titleList">
                                                ...
                                                <td style="text-align: left; width: 164px;">
                                                    <asp:TextBox ID="txt_s" runat="server" Width="156px"></asp:TextBox>
                                                </td>
                                                <td class="Middle">
                                                </td>
                                                <td style="width: 110px; text-align: right" class="titleList">
                                                ...
                                                <td style="text-align: left;">
                                                    <asp:TextBox ID="txt_e" runat="server" Height="21px" Width="156px"></asp:TextBox>
                                                </td>
                                                <td style="height: 4px" class="Middle">
                                                </td>
                                                <td class="ctrlList">
                                ...
                                <asp:Panel ID="Panel8" BackColor="#F5F9FF" runat="server" ForeColor= "#2292DD" Width="800px" Height="50px"
                                    Font-Size="X-Small" GroupingText="按分析项目">
                                    <table class="container">
                                        <tbody>
                                            <tr>
                                                <td style="width: 115px; text-align: right" class="titleList">
                                                ...
                                                <td class="titleList">
                                                    <asp:DropDownList ID="DropList_AnalysisMainItem" CssClass=" ctrlList" runat="server"
                                                        AutoPostBack="true" Width="156px" OnSelectedIndexChanged="DropList_AnalysisMainItem_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="height: 4px" class="Middle">
                                                </td>
                                                ...
                                                <td colspan="2">
                                                    <%-- <asp:RadioButtonList ID="RadioButtonList1"  RepeatDirection="Horizontal"  Font-Size="X-Small" runat="server">
                                <asp:ListItem Value="1">同时满足</asp:ListItem>
                                <asp:ListItem Value="1">分别满足</asp:ListItem>
                            </asp:RadioButtonList>--%>
                                                </td>
                                            </tr>
                                        </tbody>
                ...
                <asp:Panel ID="Panel1" runat="server" Width="100%" Height="50px" Font-Size="X-Small"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right" class="titleList">
                                <span style="font-size: 10pt">
                                <asp:Label ID="Label3" runat="server" CssClass="mLabel" Text="时间：" 
                 ...
                 <asp:Panel ID="Panel4" runat="server" Width="100%" Height="50px" Font-Size="X-Small"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right" class="titleList">
                                <span style="font-size: 10pt">
                                <asp:Label ID="Label8" runat="server" CssClass="mLabel" Text="时间：" 
                                    Width="75px"></asp:Label>
                                </span>
                            </td>
                             <td class="ctrlList">
