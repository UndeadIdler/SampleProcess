  ...
  public  class UserRole
    {
      public List<Entity.User.UserRole> RoleList(int ILevel)
      {
          ...
          try
          {
              ...
              string strSql = "select * from t_R_Role inner join t_R_UserLevel on t_R_UserLevel.id=t_R_Role.LevelID where  LevelID>'" + ILevel + "' ";
      ...
      public string RoleListListStr(int flag)
        ...
        public DataTable ListDt(int searchlevel,string role,int level)
        {
            ...
            try
            {
                ...
                string strSql = "select * from t_R_Role inner join t_R_UserLevel on t_R_Role.LevelID=t_R_UserLevel.id where t_R_UserLevel.id>" + level + "" + constr;
