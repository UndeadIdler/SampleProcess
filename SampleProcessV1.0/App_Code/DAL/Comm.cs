...
namespace DAl
{
    ...
    public class Config
    {
        ...
        public static string constr = ConfigurationSettings.AppSettings["connString"];
        public static string flagAutoNum = ConfigurationSettings.AppSettings["flagAutoNum"];
    }
