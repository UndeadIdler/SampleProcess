<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="Access1.aspx.cs" Inherits="Sample_Access11" Title="项目指派" %>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="height: 4px" class="ctrlList">
                            <asp:TextBox ID="txt_samplequery" Width="80px" runat="server"></asp:TextBox>
                        </td>
                        <td style="height: 4px" class="Middle">
                        </td>
                        <td style="text-align: right" class="titleList">
                            <span style="font-size: 10pt">
                                <asp:Label ID="Label4" runat="server" Text="开始时间"></asp:Label></span>
                        </td>
                        <td class="ctrlList">
                            <asp:TextBox ID="txt_QueryTime" runat="server" Width="80px" CssClass="mTextBox"></asp:TextBox>
                        </td>
                        <td style="height: 4px" class="Middle">
                        </td>
                        <td style="text-align: right" class="titleList">
                            <span style="font-size: 10pt">
                                <asp:Label ID="Label15" runat="server" Text="结束时间"></asp:Label></span>
                        </td>
                        <td class="ctrlList">
                            <asp:TextBox ID="txt_QueryTimeEnd" runat="server"  Width="80px" CssClass="mTextBox"></asp:TextBox>
                        </td> <td style="height: 4px" class="Middle">
                        </td>
                         </td> <td style="text-align: right" class="titleList">
                            <span style="font-size: 10pt">
                                <asp:Label ID="Label17" runat="server" Text="状态"></asp:Label></span>
                        </td>
                        <td class="ctrlList">
                           <asp:DropDownList ID="drop_tkwether" runat="server">
                               <asp:ListItem Value="0" Selected="True" Text="指派中"></asp:ListItem>
                               <asp:ListItem Value="1"  Text="已指派"></asp:ListItem>
                           </asp:DropDownList>
                        </td>
                        <td> <asp:DropDownList ID="drop_query_fa" runat="server">
                               <asp:ListItem Value="0" Selected="True" Text="所有"></asp:ListItem>
                               <asp:ListItem Value="1"  Text="需要踏勘"></asp:ListItem>
                            <asp:ListItem Value="2"  Text="不需要踏勘"></asp:ListItem>
                           </asp:DropDownList>
                        </td>
                        <td>
                ...
                <table style="width: 800px">
                        ...
                        <tr>
                            ...
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="lbl_reportNO" runat="server" Text="报告标识" CssClass="mLabel" Width="80px"></asp:Label>
                            </td>
                            <td class="ctrlList">
                ...
                <tr><td colspan="6">
                    ...
                    Width="800px">
                        <table>
                            ...
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                                <asp:TextBox ID="txt_remak1" runat="server" TextMode="MultiLine" Height="75px" Width="100%"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                            </td>
                        </tr>
                            ...
                            <td>
                                ...
                                <td style="font-size: x-small;" class="titleList">
                                  <asp:Label ID="Label14" runat="server" Text="科室指派人"></asp:Label>
                                </td>
                                <td class="ctrlList">
                                 <%-- <asp:TextBox ID="txt_xmfzr" runat="server"></asp:TextBox>--%>
                                  <asp:TextBox runat="server" ID="txt_ksfzr" Width="125px" autocomplete="off"
                                    Height="22px" />
                                </td>
                     ...
                     <tr><td colspan="6">
                    <asp:Panel ID="Panel3" BackColor="#F5F9FF" runat="server" GroupingText="项目指派" ForeColor="#2292DD" Font-Size="Smaller"
                    Width="800px">
                        <table>
                             <tr>
                                <td style="font-size: x-small;" class="titleList">
                                  <asp:Label ID="Label20" runat="server" Text="项目负责人"></asp:Label>
                                </td>
                                <td class="ctrlList">
                                 <%-- <asp:TextBox ID="txt_xmfzr" runat="server"></asp:TextBox>--%>
                                  <asp:TextBox runat="server" ID="txt_xmfzr" Width="125px" autocomplete="off"
                                    Height="22px" />
                                <ajaxToolkit:AutoCompleteExtender runat="server" BehaviorID="AutoCompleteEx" ID="AutoCompleteExtender1"
                    ...
                    <OnHide>
                        ...
                        <Parallel Duration=".4">
                            ...
                            <Length PropertyKey="height" StartValueScript="$find('AutoCompleteEx')._height" EndValue="0" />
                               ...
                               <%-- <td  colspan="2" style="width:100px">
                                    <asp:CheckBox ID="CheckBox1" Width="100px" runat="server" CssClass="mLabel"  Text="需要踏勘"  Checked="true"/>
                            ...
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                                <asp:TextBox ID="txt_zpremark" runat="server" TextMode="MultiLine" Height="75px" Width="100%"></asp:TextBox>
                            </td></tr>  
                        </table>
                    </asp:Panel>
                         </td></tr>
                   ...
                   <tr><td colspan="6"> <asp:Panel ID="panel_csyj" BackColor="#F5F9FF" runat="server" GroupingText="退回说明" ForeColor="#2292DD" Font-Size="Smaller"
                    Width="800px">
                        <table>
                         ...
                         <tr>
                            ...
                            <td style="width: 600px;" colspan="5">
                                <asp:TextBox ID="txt_backremark" runat="server" Height="70px" TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
