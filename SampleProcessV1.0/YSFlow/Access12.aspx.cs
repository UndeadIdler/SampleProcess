...
public partial class Sample_Access_1 : System.Web.UI.Page
{
    ...
    protected void grdvw_List_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        {
            if (grdvw_List.Rows[e.NewEditIndex].Cells[25].Text.Trim() != "&nbsp;" && grdvw_List.Rows[e.NewEditIndex].Cells[25].Text.Trim() != "")
            {
                txt_wtdepart.Text = grdvw_List.Rows[e.NewEditIndex].Cells[25].Text.Trim();
            }
        ...
        if (grdvw_List.Rows[e.NewEditIndex].Cells[26].Text.Trim() != "&nbsp;" && grdvw_List.Rows[e.NewEditIndex].Cells[26].Text.Trim() != "")
        {
            txt_xmfzr.Text = grdvw_List.Rows[e.NewEditIndex].Cells[26].Text.Trim();
        }
