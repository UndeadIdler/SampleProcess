<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="Access2.aspx.cs" Inherits="Sample_Access2" Title="现场踏勘" %>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="height: 4px" class="Middle">
                            ...
                            <span style="font-size: 10pt">
                                <asp:Label ID="Label17" runat="server" Text="踏勘情况"></asp:Label></span>
                        </td>
                        <td class="ctrlList">
                           <asp:DropDownList ID="drop_tkwether" runat="server">
                               <asp:ListItem Value="0" Selected="True" Text="踏勘中"></asp:ListItem>
                               <asp:ListItem Value="1"  Text="踏勘未通过"></asp:ListItem>
                           </asp:DropDownList>
                        </td>
                        <td>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <tr><td colspan="6">
                    ...
                    <tr><td colspan="6">
                     <asp:Panel ID="panel_back" BackColor="#F5F9FF" runat="server" GroupingText="退回情况" ForeColor="#2292DD" Font-Size="Smaller"
                    Width="800px">
                        <table>
                           <tr>
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label16" runat="server" Text="情况说明" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                                <asp:TextBox ID="txt_back" runat="server" Height="75px" TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                            </td>
                        </tr>
