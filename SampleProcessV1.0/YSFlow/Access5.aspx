<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="Access5.aspx.cs" Inherits="Sample_Access5" Title="报告编制" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <tr><td colspan="6">
                    ...
                    <tr><td colspan="7">
                         <asp:Panel ID="Panel5" BackColor="#F5F9FF" runat="server" GroupingText="现场监测" ForeColor="#2292DD" Font-Size="Smaller"
                    Width="800px">
                        <table>
                           <%-- <tr><td style="width: 150px" class="titleList">
                                <asp:Label ID="Label19" runat="server" Text="是否完成" CssClass="mLabel"></asp:Label>
                            </td><td>
                                <asp:RadioButtonList ID="rbl_xcjc" runat="server" RepeatDirection="Horizontal" CssClass="mLabel">
                                    <asp:ListItem Value="0" Selected="True" Text="是"></asp:ListItem>
                                    <asp:ListItem Value="1" Text="否"></asp:ListItem>
                                </asp:RadioButtonList>
                                 </td><td colspan="4" style="width:300px"></td></tr>--%>
                            ...
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label20" runat="server" Text="现场监测情况" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                    ...
                    <tr><td colspan="6">
                     <asp:Panel ID="Panel4" BackColor="#F5F9FF" runat="server" GroupingText="报告编制" ForeColor="#2292DD" Font-Size="Smaller"
                    Width="800px">
                        <table>
                            <tr><td style="width: 150px" class="titleList">
                                <asp:Label ID="Label16" runat="server" Text="报告编号" CssClass="mLabel"></asp:Label>
                            </td><td>
                                 <asp:TextBox ID="txt_ReportNO" runat="server"  Width="200px"></asp:TextBox>
                                 </td><td colspan="4" style="width:300px"></td></tr>
                                 <tr>
                          
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label18" runat="server" Text="备注" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                                <asp:TextBox ID="txt_Remark4" runat="server" Height="200px" TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                            </td>
                        </tr>
