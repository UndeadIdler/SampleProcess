<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="Access01.aspx.cs" Inherits="Sample_Access01" Title="项目初审" %>
                    ...
                    <tr>
                        ...
                        <td class="ctrlList">
                           <asp:DropDownList ID="drop_tkwether" runat="server">
                               <asp:ListItem Value="0" Selected="True" Text="初审中"></asp:ListItem>
                               <asp:ListItem Value="1"  Text="初审未通过"></asp:ListItem>
                               <asp:ListItem Value="2"  Text="初审通过"></asp:ListItem>
                           </asp:DropDownList>
                        </td>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <tr><td colspan="6">
                        ...
                        <table>
                            ...
                            <td>
                                ...
                                <ajaxToolkit:AutoCompleteExtender runat="server" BehaviorID="AutoCompleteEx" ID="AutoCompleteExtender2"
                                    TargetControlID="txt_xmfzr" ServicePath="Complete.asmx" ServiceMethod="GetUserList2"
                                    MinimumPrefixLength="0" CompletionInterval="200" EnableCaching="true" CompletionSetCount="20"
                                    CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem"
                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" DelimiterCharacters=";, :">
                                    <Animations>
                   ...
                   <tr><td colspan="6"> <asp:Panel ID="panel_csyj" BackColor="#F5F9FF" runat="server" GroupingText="指派退回" ForeColor="#2292DD" Font-Size="Smaller"
                    Width="800px">
                        <table>
