<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="Access3.aspx.cs" Inherits="Sample_Access3" Title="验收方案编制" %>
                    ...
                    <tr>
                        ...
                        <td class="ctrlList">
                           <asp:DropDownList ID="drop_tkwether" runat="server">
                               <asp:ListItem Value="0" Selected="True" Text="踏勘通过"></asp:ListItem>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <tr><td colspan="6">
                    ...
                    <tr><td colspan="6">
                     <asp:Panel ID="panel_han" BackColor="#F5F9FF" runat="server" GroupingText="方案编写" ForeColor="#2292DD" Font-Size="Smaller"
                    Width="800px">
                        <table>
                           <tr>
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label17" runat="server" Text="备注" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                                <asp:TextBox ID="txt_Content" runat="server"  TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="float_Padding" colspan="5" align="center">
                                <asp:Button ID="btn_OK" OnClick="btn_OK_Click" runat="server" Text="退回" CssClass="mButton" OnClientClick="if(!confirm('确定退回该项吗？')) return false;">
                                </asp:Button>  
                                <asp:Button ID="btn_Save" OnClick="btn_Save_Click" runat="server" Text="保存" CssClass="mButton">
                                </asp:Button>                                
                            </td>
                            <td style="height: 4px" class="float_Middle">
                            </td>
