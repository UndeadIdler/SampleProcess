<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="Access4.aspx.cs" Inherits="Sample_Access4" Title="函编制" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                    ...
                    <tr>
                        ...
                        <td class="ctrlList">
                           <asp:DropDownList ID="drop_tkwether" runat="server">
                              <asp:ListItem Value="3"  Text="未发文"></asp:ListItem>
                               <asp:ListItem Value="5"  Text="已发文"></asp:ListItem>
                           </asp:DropDownList>
                        </td>
                        <td>
            ...
            <asp:GridView ID="grdvw_List" runat="server" CssClass="mGridView" OnPageIndexChanging="grdvw_List_PageIndexChanging" AllowPaging="true" PageSize="12" 
                OnRowDeleting="grdvw_List_RowDeleting" OnRowEditing="grdvw_List_RowEditing" OnRowCreated="grdvw_List_RowCreated"  OnSelectedIndexChanging="grdvw_List_SelectedIndexChanging">
                <Columns>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <tr><td colspan="6">
                    ...
                    <tr><td colspan="6">
                     <asp:Panel ID="panel_han" BackColor="#F5F9FF" runat="server" GroupingText="整改函" ForeColor="#2292DD" Font-Size="Smaller"
                    Width="800px">
                        <table>
                           <tr>
                            <td class="titleList">
                                <asp:Label ID="Label17" runat="server" Text="整改意见" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                                <asp:TextBox ID="txt_Content" runat="server" Height="200px" TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                            </td>
                        </tr>
                <tr>
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label16" runat="server" Text="发文单位：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                                <asp:TextBox ID="txt_fwdw" runat="server" Height="25px"  Text="桐乡市环境保护监测站" Width="100%"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                            </td>
                        </tr>
                             <tr>
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label18" runat="server" Text="抄送：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                                <asp:TextBox ID="txt_cs" runat="server" Height="25px"  Width="100%"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                                <asp:LinkButton ID="lb_cs" runat="server" OnClick="lb_cs_Click">选择...</asp:LinkButton>
                            </td>
                        </tr>
                            <tr><td colspan="5">
                                <asp:CheckBoxList ID="cbl_cs" runat="server" RepeatDirection="Horizontal" RepeatColumns="3" Visible="false" Width="90%" AutoPostBack="true" OnSelectedIndexChanged="cbl_cs_SelectedIndexChanged"></asp:CheckBoxList></td></tr>
                        </table>
                    </asp:Panel>
                    </td></tr>
                        <tr>
                            ...
                            <td class="float_Padding" colspan="5" align="center">
                                ...
                                <asp:Button ID="btn_OK" OnClick="btn_OK_Click" runat="server" Text="保存" CssClass="mButton">
                                 ...
                                 <asp:Button ID="btn_Save" OnClick="btn_Save_Click" runat="server" Text="发文" CssClass="mButton">
                                </asp:Button>
                                 <asp:Button ID="btn_print" OnClick="btn_print_Click" runat="server" Text="打印" CssClass="mButton">
                                </asp:Button>
                            </td>
                            <td style="height: 4px" class="float_Middle">
                            </td>
