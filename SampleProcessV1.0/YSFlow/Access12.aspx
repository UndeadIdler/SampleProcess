<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="Access12.aspx.cs" Inherits="Sample_Access_1" Title="项目指派" %>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="height: 4px" class="ctrlList">
                            <asp:TextBox ID="txt_samplequery" Width="85px"  runat="server"></asp:TextBox>
                        </td>
                        ...
                        <td class="ctrlList">
                            <asp:TextBox ID="txt_QueryTime" runat="server" Width="85px"  CssClass="mTextBox"></asp:TextBox>
                        </td>
                        <td style="height: 4px" class="Middle">
                        </td>
                        <td style="text-align: right" class="titleList">
                        ...
                        <td class="ctrlList">
                            <asp:TextBox ID="txt_QueryTimeEnd" runat="server" Width="85px" CssClass="mTextBox"></asp:TextBox>
                        </td>
                        <td style="height: 4px" class="Middle">
                        </td>
                        ...
                        <td class="ctrlList">
                           <asp:DropDownList ID="drop_tkwether" runat="server">
                               <asp:ListItem Value="0" Selected="True" Text="未指派"></asp:ListItem>
                               <asp:ListItem Value="1"  Text="已指派"></asp:ListItem>
                           </asp:DropDownList>
                        </td>
                        <td> <asp:CheckBox ID="cb_query_fa" Width="100px" runat="server" CssClass="mLabel"  Text="需要踏勘"  Checked="true"/>
                                </td>
                        <td>
                ...
                <tr><td colspan="6">
                    ...
                    Width="800px">
                        <table>
                            ...
                            <td style="font-size: x-small; width: 600px; text-align: right;" colspan="5">
                                <asp:TextBox ID="txt_remak1" runat="server" TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                            </td>
                        </tr>
                        ...
                        <Parallel Duration=".4">
                            ...
                            <Length PropertyKey="height" StartValueScript="$find('AutoCompleteEx')._height" EndValue="0" />
                                ...
                                <td  colspan="2" style="width:100px">
                                    <asp:CheckBox ID="ck_fa" Width="100px" runat="server" CssClass="mLabel"  Text="需要踏勘"  Checked="true"/>
                    ...
                    Width="800px">
                        <table>
                             <tr>
                                ...
                                <td class="ctrlList">
                                 <%-- <asp:TextBox ID="txt_xmfzr" runat="server"></asp:TextBox>--%>
                                  <asp:TextBox runat="server" ID="TextBox2" Width="125px" autocomplete="off"
                                    Height="22px" />
