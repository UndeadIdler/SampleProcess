<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="access14.aspx.cs" Inherits="ExamineReport_access14" Title="办公室装订" %>
...
<script language="javascript" type="text/javascript" src="../js/cal/WdatePicker.js"></script>
    ...
    <div id="detail" class="mLayer" style="display:none;left: 96px; width: 739px; top: 500px;
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
            <asp:Panel ID="Panel2" BackColor="#F5F9FF" runat="server" GroupingText="综合室项目受理" ForeColor="#2292DD"
                    Width="800px">
                <table style="margin: 0px; width:100%">
                    <tbody>
                        ...
                        <tr>
                         ...
                         <asp:Panel ID="Panel1" BackColor="#F5F9FF" runat="server" GroupingText="外业室确认" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                    ...
                    <asp:Panel ID="Panel4" BackColor="#F5F9FF" runat="server" GroupingText="外业室完成现场踏勘" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                     ...
                     <asp:Panel ID="Panel3" BackColor="#F5F9FF" runat="server" GroupingText="验收方案室内审核" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                     ...
                     <asp:Panel ID="Panel5" BackColor="#F5F9FF" runat="server" GroupingText="方案上传" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                     ...
                     <asp:Panel ID="Panel6" BackColor="#F5F9FF" runat="server" GroupingText="综合室确认" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                    ...
                    <asp:Panel ID="Panel7" BackColor="#F5F9FF" runat="server" GroupingText="综合室签订协议" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                       ...
                       <tr>
                        <td colspan="4">
                                <asp:GridView ID="GridView7" runat="server" CssClass="mGridView" Caption="" 
                                   > 
                                </asp:GridView>
                    ...
                    <asp:Panel ID="Panel8" BackColor="#F5F9FF" runat="server" GroupingText="外业室完成监测" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                       ...
                       <tr>
                        <td colspan="4">
                                <asp:GridView ID="GridView8" runat="server" CssClass="mGridView" Caption="" 
                                   > 
                                </asp:GridView>
                    ...
                    <asp:Panel ID="Panel9" BackColor="#F5F9FF" runat="server" GroupingText="综合室向外业室移交数据" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                       ...
                       <tr>
                        <td colspan="4">
                                <asp:GridView ID="GridView9" runat="server" CssClass="mGridView" Caption="" 
                                   > 
                                </asp:GridView>
                    ...
                    <asp:Panel ID="Panel10" BackColor="#F5F9FF" runat="server" GroupingText="报告编制及上传" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                       ...
                       <tr>
                        <td colspan="4">
                                <asp:GridView ID="GridView10" runat="server" CssClass="mGridView" Caption="" 
                                   > 
                                </asp:GridView>
                      ...
                      <asp:Panel ID="Panel11" BackColor="#F5F9FF" runat="server" GroupingText="室内审核报告" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                       ...
                       <tr>
                        <td colspan="4">
                                <asp:GridView ID="GridView11" runat="server" CssClass="mGridView" Caption="" 
                                   > 
                                </asp:GridView>
                     ...
                     <asp:Panel ID="Panel12" BackColor="#F5F9FF" runat="server" GroupingText="外业室报告修改" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                       ...
                       <tr>
                        <td colspan="4">
                                <asp:GridView ID="GridView12" runat="server" CssClass="mGridView" Caption="" 
                                   > 
                                </asp:GridView>
                    ...
                    <asp:Panel ID="Panel13" BackColor="#F5F9FF" runat="server" GroupingText="综合室审定报告" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                       ...
                       <tr>
                        <td colspan="4">
                                <asp:GridView ID="GridView13" runat="server" CssClass="mGridView" Caption="" 
                                   > 
                                </asp:GridView>
                     ...
                     <asp:Panel ID="Panel14" BackColor="#F5F9FF" runat="server" GroupingText="外业室修改报告" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                       ...
                       <tr>
                        <td colspan="4">
                                <asp:GridView ID="GridView14" runat="server" CssClass="mGridView" Caption="" 
                                   > 
                                </asp:GridView>
                     ...
                     <asp:Panel ID="Panel_now" BackColor="#F5F9FF" runat="server" GroupingText="办公室装订" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                         <tr>
