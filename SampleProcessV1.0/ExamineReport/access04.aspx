<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="access04.aspx.cs" Inherits="ExamineReport_access04" Title="现场监测" %>
            ...
            <asp:Panel ID="Panel2" BackColor="#F5F9FF" runat="server" GroupingText="综合室业务受理" ForeColor="#2292DD"
                ...
                <table style="margin: 0px; width:100%">
                    ...
                    Width="800px">
                     ...
                     <asp:Panel ID="Panel_now" BackColor="#F5F9FF" runat="server" GroupingText="函综合室外发/业务室完成监测" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                         <tr>
