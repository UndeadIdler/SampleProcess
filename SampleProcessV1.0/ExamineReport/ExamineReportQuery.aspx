<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="ExamineReportQuery.aspx.cs" Inherits="ExamineReportQuery" Title="Untitled Page" %>
                     ...
                     <td class="querytitleList">
                            <asp:DropDownList ID="drop_fanganQuery" runat="server">
                              <asp:ListItem Text="所有" Value=""></asp:ListItem>
                                   <asp:ListItem Text="需要踏勘" Value="1"></asp:ListItem>
                                   <asp:ListItem Text="不需要踏勘" Value="0"></asp:ListItem>
                           </asp:DropDownList>
                        </td>
                      <td  width="80px" style="text-align:center;">
                           <asp:Label ID="Label6" runat="server"  Text="项目负责人"></asp:Label>
                        </td>
                        <td class="querytitleList">
                             <asp:TextBox ID="txt_chargeman" runat="server" CssClass="mTextBox" style="text-align:center;vertical-align:middle"  Width="85px"></asp:TextBox>
                        </td>
                   </tr>
                    <tr>
                        <td  width="80px" style="text-align:center;">
                        ...
                        <td class="queryctrlList" style="width: 90px">
                         ...
                         <tr> <td colspan='6' style=" height:15px"><asp:Label ID="lbl_remark" Width="100%" Text="注：红色-未完成;绿色-已完成;" runat="server" CssClass="ctrlList"></asp:Label></td></tr>
                </tbody>
            </table>                     
             <%=strTable %>   <br>                 
