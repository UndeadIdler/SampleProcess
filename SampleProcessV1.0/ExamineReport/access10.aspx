<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="access10.aspx.cs" Inherits="ExamineReport_access10" Title="室内审核报告" %>
            ...
            <asp:Panel ID="Panel2" BackColor="#F5F9FF" runat="server" GroupingText="综合室业务受理" ForeColor="#2292DD"
                ...
                <table style="margin: 0px; width:100%">
                    ...
                    Width="800px">
                     ...
                     <asp:Panel ID="Panel6" BackColor="#F5F9FF" runat="server" GroupingText="函外发/完成监测" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                    ...
                    <asp:Panel ID="Panel7" BackColor="#F5F9FF" runat="server" GroupingText="监测数据移交" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                    ...
                    <asp:Panel ID="Panel8" BackColor="#F5F9FF" runat="server" GroupingText="报告编制" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                    ...
                    <asp:Panel ID="Panel9" BackColor="#F5F9FF" runat="server" GroupingText="报告审核" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                    ...
                    <asp:Panel ID="Panel10" BackColor="#F5F9FF" runat="server" GroupingText="报告审定" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                     ...
                     <asp:Panel ID="Panel_now" BackColor="#F5F9FF" runat="server" GroupingText="报告发放装订" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                         <tr>
