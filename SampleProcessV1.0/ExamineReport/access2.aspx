<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="access2.aspx.cs" Inherits="ExamineReport_access2" Title="现场检测" %>
            ...
            <asp:Panel ID="Panel2" BackColor="#F5F9FF" runat="server" GroupingText="综合室项目受理" ForeColor="#2292DD"
                ...
                <table style="margin: 0px; width:100%">
                    ...
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                         <%--<tr>
                            ...
                            <td style="width: 10%; text-align: right" class="titleList">
                                <span style="font-size: 10pt">外业室收到人</span>
                            </td>
                            <td class="ctrlList" style="width: 90%; ">
                                <asp:TextBox ID="txt_person1" runat="server" CssClass="mTextBox"></asp:TextBox>
                            </td>
                             <td style="width: 10%; text-align: right" class="titleList">
                                <span style="font-size: 10pt">移交时间</span></td>
                            <td style="width: 90%; " class="ctrlList">
                                <asp:TextBox ID="txt_date1" runat="server" CssClass="mTextBox"></asp:TextBox>
                            </td>
                     ...
                     <asp:Panel ID="Panel3" BackColor="#F5F9FF" runat="server" GroupingText="现场踏勘" ForeColor="#2292DD"
                    Width="800px">
                       <table style="margin: 0px; width: 100%">
                        <tbody>
                         <tr>
