<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="AnalysisItemSpecial.aspx.cs" Inherits="BaseData_AnalysisItemSpecial" Title="标签打印设置"
                ...
                <table style="width: 780px">
                    <tbody> 
                        ...
                        <tr> <td style="width: 38px" class="Middle">
                            ...
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label3" runat="server" Text="分析方法：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td colspan="3">
                        ...
                        <tr><td></td><td colspan="4">
                            <asp:Panel runat="server" GroupingText="分析方法选择" ID="panel_choose" Visible="false">
                                 ...
                                 <asp:CheckBoxList runat="server" ID="cbl_choose"  RepeatColumns="2" RepeatDirection="Horizontal" OnSelectedIndexChanged="cbl_choose_SelectedIndexChanged"></asp:CheckBoxList>
                            </asp:Panel>
                            </td></tr>--%>
                        <tr>
