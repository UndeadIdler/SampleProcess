<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="WTStationInfo.aspx.cs" Inherits="BaseData_WTStationInfo" Title="委托单位" %>
        ...
        <ContentTemplate>
            <table class="containerb">
                <tbody>
                    ...
                    <tr>
                         <td class="titleList">
                            <asp:Label ID="Label3" runat="server" CssClass="mLabel" Text="Label">属地：</asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="drop_area_query" runat="server"></asp:DropDownList>
            ...
            <asp:GridView ID="grdvw_List" runat="server" CssClass="mGridView" OnRowDeleting="grdvw_List_RowDeleting" Width="98%"
                ...
                AllowPaging="false" PageSize="20" OnPageIndexChanging="grdvw_List_PageIndexChanging">
                <Columns>
                                            ...
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="30"  colspan="4">
                                                            <asp:TextBox ID="txt_frdm" runat="server" CssClass="mTextBox" Width="98%"></asp:TextBox>
                                                        </td>
                                                        <td height="30" bgcolor="#f2f2f2" style="width: 100%" colspan="2">
                                                            <asp:Label ID="Label4" runat="server" Text="法人代码，必填！" CssClass="left_txt"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="30" align="right"  class="left_txt2" colspan="2">
