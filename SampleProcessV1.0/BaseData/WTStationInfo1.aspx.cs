...
public partial class BaseData_WTStationInfo1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            grdvw_List.Caption = "<FONT style='WIDTH: 102.16%; COLOR: #50598d;font-size:14pt; LINE-HEIGHT: 150%; FONT-FAMILY: 楷体_GB2312; HEIGHT: 35px'><b>监管单位信息</b></font>";
    ...
    private void Query()
    {
         string strSql = "select t_委托单位.id,单位全称,单位详细地址,邮政编码,单位曾用名全称 from t_委托单位 where type=1   ";
        ...
        strCondition += " order by t_委托单位.id";
