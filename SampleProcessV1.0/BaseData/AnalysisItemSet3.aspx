<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="AnalysisItemSet3.aspx.cs" Inherits="BaseData_AnalysisItemSet1" Title="分析项目维护"
                    ...
                    <tbody>    
                        ...
                        <tr>
                            ...
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label3" runat="server" Text="样品类型" CssClass="mLabel"></asp:Label>
                            </td>
                            <td class="ctrlList">
                        ...
                        <tr><td></td><td colspan="4">
                            <asp:Panel runat="server" GroupingText="分析方法选择" ID="panel_choose" Visible="false">
                                 ...
                                 <asp:CheckBoxList runat="server" ID="cbl_choose"  RepeatColumns="2" RepeatDirection="Horizontal" AutoPostBack="true"  OnSelectedIndexChanged="cbl_choose_SelectedIndexChanged"></asp:CheckBoxList>
                            </asp:Panel>
                            </td></tr>
                        <tr>
                        <tr>
