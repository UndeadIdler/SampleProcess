...
public partial class BaseData_SampleTypeSet : System.Web.UI.Page
{
    ...
    private void Query()
    {
        string strSql = "select ClassID,ClassName,ClassCode from t_M_AnalysisMainClassEx order by class";
    ...
    protected void grdvw_List_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        strSql = "select * from t_M_AnalysisMainClassEx where ClassID = '" + strSelectedId + "'";
        DataSet ds = new MyDataOp(strSql).CreateDataSet();
   
        if (ds.Tables.Count == 1)
        {
            strSql = "DELETE FROM t_M_AnalysisMainClassEx WHERE ClassID = '" + strSelectedId + "'";
    ...
    protected void grdvw_List_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        string strSql = @"select * from t_M_AnalysisMainClassEx 
    ...
    protected void btn_OK_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (lbl_Type.Text == "添加")
            {
                ...
                string strSql = @"insert into t_M_AnalysisMainClassEx
                        (ClassName,ClassCode)  
            ...
            if (lbl_Type.Text == "编辑")
            {
                string strSql = @"update t_M_AnalysisMainClassEx 
