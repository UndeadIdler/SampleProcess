<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="SampleTypeSet.aspx.cs" Inherits="BaseData_SampleTypeSet" Title="Untitled Page"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 <script language="javascript" type="text/javascript" src="../js/position.js"></script>
    ...
    <div class="mLayer" style="left: 223px; top:203px; width: 363px; height: 150px;        display: none;" id="detail">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label1" runat="server" Text="样品类型：" CssClass="mLabel" ></asp:Label>
                            </td>
                            <td class="ctrlList">
                                <asp:TextBox ID="txt_ClassName" runat="server" CssClass="mTextBox"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td style="width: 38px" class="Middle"></td>
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label2" runat="server" Text="样品类型代码：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td class="ctrlList">
                                <asp:TextBox ID="txt_ClassCode" runat="server" CssClass="mTextBox"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                            </td>
                        </tr>
