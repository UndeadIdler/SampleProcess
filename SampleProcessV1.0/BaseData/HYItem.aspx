<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="HYItem.aspx.cs" Inherits="BaseData_HYItem" Title="行业类型"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <%--<script language="javascript" type="text/javascript" src="../js/cal/WdatePicker.js" ></script>--%>
    ...
    <div class="mLayer" style="left: 223px; top: 543px; width: 650px; height: 150px;display:none;" id="detail">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 119px" class="titleList">
                                <asp:Label ID="Label1" runat="server" Text="行业名称：" CssClass="mLabel" ></asp:Label>
                            </td>
                            <td class="ctrlList">
                                <asp:TextBox ID="txt_hy" runat="server" CssClass="mTextBox"></asp:TextBox>                               
                            </td>
                        ...
                        <tr>
                            <td style="width: 38px" class="Middle"></td>
                            <td style="width: 119px" class="titleList">
                                <asp:Label ID="Label2" runat="server" Text="行业代码：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td class="ctrlList">
                                <asp:TextBox ID="txt_hyCode" runat="server" CssClass="mTextBox"></asp:TextBox>
                            </td>
                            <td class="float_Middle">
                            </td>
                        </tr>
                       <%-- <tr>
                            ...
                            <td class="ctrlList">
                                <asp:DropDownList ID="drop_bz" runat="server" CssClass="mDropDownList" Width="450px"></asp:DropDownList>
