<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="HYItemParam.aspx.cs" Inherits="BaseData_HYItemParam" Title="污染物指标对应"
                ...
                <table style="width: 850px">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  class="ctrlList">
                                <asp:Label ID="Label1" runat="server" Text="行业：" CssClass="mLabel" ></asp:Label>
                            </td>
                            <td class="ctrlList">
                                <asp:DropDownList ID="drop_hy" runat="server"></asp:DropDownList>    
                            </td>
                            ...
                            <td class="ctrlList">
                              <asp:TextBox runat="server" ID="DropList_SampleType" Width="185px" autocomplete="off"
                                ...
                                <ajaxToolkit:AutoCompleteExtender runat="server" BehaviorID="AutoCompleteExx" ID="AutoCompleteExtender1"
                                    TargetControlID="DropList_SampleType" ServicePath="AutoGet.asmx" ServiceMethod="GetSampleTypeList"
                    ...
                    <OnHide>
                        ...
                        <Parallel Duration=".4">
                            ...
                            <td class="ctrlList" colspan="3">
                                <asp:DropDownList ID="drop_bz" runat="server" CssClass="mDropDownList" Width="98%">
                                                            </asp:DropDownList>  
                            </td>
                        </tr>
                        <tr>
