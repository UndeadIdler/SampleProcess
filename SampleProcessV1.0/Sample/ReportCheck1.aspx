<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="ReportCheck1.aspx.cs" Inherits="Sample_ReportCheck" Title="报告校核" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="DetailAnalysis" class="mLayer" style="display:none; left: 96px; width: 739px; top: 500px;
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            <ContentTemplate>
            <asp:Panel ID="Panel1" BackColor="#F5F9FF" runat="server" GroupingText="报告校核" ForeColor="#2292DD"
                Width="800px">
                ...
                <table class="container">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="650px">
                                <asp:TextBox ID="txt_ReportRemark" ReadOnly="true" runat="server" TextMode="MultiLine" Height="67px"
                                    Width="650px"></asp:TextBox>
                            </td>
                        </tr>
                        </tbody>
                        </table>
                        <asp:Panel ID="Panel2" BackColor="#F5F9FF" runat="server" GroupingText="报告校核填写" ForeColor="#2292DD"
                Width="800px">
                <table class="container">
                    <tbody>
                        <tr>
                ...
                <asp:Panel ID="Panel3" BackColor="#F5F9FF"  runat="server" GroupingText="报告审核意见" ForeColor="#2292DD"
                Width="800px">
                <table class="container">
                    <tbody>
                        ...
                        <tr>
                            <td width="200px">
                                <span style="font-size: 10pt;">
                                    <asp:Label ID="Label4" CssClass="mLabel" runat="server" Text="备注"></asp:Label></span>
                            </td>
                            <td width="650px">
