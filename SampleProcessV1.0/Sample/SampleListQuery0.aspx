<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="SampleListQuery0.aspx.cs" Inherits="Sample_SampleListQuery0" Title="样品列表" %>
  ...
  newwin.document.close();
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <asp:Panel ID="Panel6" BackColor="#F5F9FF" runat="server" GroupingText="查询条件" ForeColor= "#2292DD" Width="800px">
           ...
           </asp:Panel> <div align="right"><asp:Label ID="Label2" runat="server" Text="标签开始项"></asp:Label><asp:TextBox ID="txt_NO" Text="1" runat="server" 
