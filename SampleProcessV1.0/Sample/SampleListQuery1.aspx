<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="SampleListQuery1.aspx.cs" Inherits="Query_SampleListQuery1" Title="Untitled Page" %>
        ...
        <table class="container">
                <tbody> <tr>              
                        ...
                        <td class="queryctrlList" style="width: 90px">
                         ...
                         <tr> <td colspan='6' style=" height:15px">
            <div style=" text-align:center; position:inherit; top:1px; width:800px; height: 15px;"><FONT style='WIDTH: 102.16%; COLOR: #2292DD;font-size:14pt; LINE-HEIGHT: 150%; FONT-FAMILY: 楷体_GB2312; HEIGHT: 35px'><b>已完成样品列表</b></font></div>
...
<div id="design1">   <asp:Label ID="Samplelist" runat="server" Text=""></asp:Label>
</div>
<%--<div id="design2"></div><%=outputStr%>--%>
</div>
</div>
</div>
