<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"  
    CodeFile="AccessSample4.aspx.cs" Inherits="AccessSample4" Title="样品接收" %>
                    ...
                    Width="800px">
                        ...
                        <ItemTemplate>
                           <tr>
                                ...
                                <tr> 
                                    <td style="text-align: right; font-size: x-small; width: 75px;" ">
                                <asp:Label ID="lbl_SampleID" runat="server" Text="样品编号" Visible="false" ></asp:Label>
                            </td>
                             <td style="width: 100px">
                                <asp:TextBox ID="txt_SampleID" Text='<%#Eval("样品编号") %>' runat="server" Width="100px" Visible="false" ReadOnly="true" ></asp:TextBox><asp:HiddenField ID="hid_ID1" runat="server" />
                            </td>
                             <td style="text-align: right; font-size: x-small; width: 75px;" ">
