<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="ReportSign1.aspx.cs" Inherits="Sample_ReportSign1" Title="报告签发" %>
                   ...
                   <asp:Panel ID="Panel3" BackColor="#F5F9FF" runat="server" GroupingText="报告审核" ForeColor="#2292DD"
                        ...
                        <table class="container">
                            ...
                            <td class="ctrlList">
                                ...
                                <asp:Panel ID="Panel4" BackColor="#F5F9FF" runat="server" GroupingText="报告签发人填写" ForeColor="#2292DD"
                        Width="800px">
                        <table class="container">
