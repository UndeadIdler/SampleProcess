<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="ReportSample.aspx.cs" Inherits="Sample_ReportSample" Title="报告编制" %>
...
<%--<tr><td colspan="6"></td><td>
            ...
            <asp:GridView ID="grdvw_List" runat="server" CssClass="mGridView" Caption=""
               ...
               OnRowEditing="grdvw_List_RowEditing" OnSelectedIndexChanging="grdvw_List_RowSelecting"
              >
                <Columns>
       ...
       <table style="width: 100%">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <table>
                    <tr> <td> <asp:Label ID="Label21" runat="server" Text="样品类型" CssClass="mLabel"></asp:Label></td>
                        <td><asp:DropDownList ID="drop_type" runat="server" CssClass="ctrlList" Width="125px" OnSelectedIndexChanged="drop_type_SelectedIndexChanged" AutoPostBack="true">
                           
                                </asp:DropDownList></td>
                        <td> <asp:Label ID="Label20" runat="server" Text="监测项" CssClass="mLabel"></asp:Label></td>
                        <td><dde:DropDownListExtend ID="dde_item"  Text="" Width="100px" CssClass="mTextBox" runat="server"  OnTextChanged="dde_item_TextChanged" ></dde:DropDownListExtend>
                            
                               </td>
                        <td> <asp:Label ID="Label19" runat="server" Text="监测状态" CssClass="mLabel"></asp:Label></td>
                        <td><asp:DropDownList ID="drop_jcstatus" runat="server" CssClass="ctrlList" Width="125px" OnSelectedIndexChanged="drop_jcstatus_SelectedIndexChanged" AutoPostBack="true">
                            <asp:ListItem Value="" Text="所有"></asp:ListItem>
                            <asp:ListItem Value="0" Text="未指派"></asp:ListItem>
                             <asp:ListItem Value="1" Text="未领用"></asp:ListItem>
                             <asp:ListItem Value="2" Text="分析中"></asp:ListItem>
                             <asp:ListItem Value="3" Text="完成"></asp:ListItem>
                                </asp:DropDownList></td>
                        <td> <asp:Button ID="btn_sx" OnClick="btn_sx_Click" runat="server" Text="筛选"  CssClass="mButton"> </asp:Button ></td>
                    </tr></table>
            ...
            <table class="container">
                <tbody>
                     <tr><td width="100px" > <span style="font-size: 10pt;" >
                            ...
                            </td><td><asp:Button ID="btn_upload" OnClick="btn_upload_Click"  Visible="false" Enabled="false" runat="server" Text="报告上传" CssClass="mButton">
                            </asp:Button></td></tr>
                        <tr><td width="100px" colspan="1" > <span style="font-size: 10pt;" >
                    ...
                    <tr>                       
                      ...
                      <td width="100px" > <span style="font-size: 10pt;" >
                                    <asp:Label ID="Label22" CssClass="mLabel" runat="server" Text="按收样日期"></asp:Label></span></td>  <td > <asp:TextBox ID="txt_exportdate" runat="server" 
                                     Width="100px"></asp:TextBox><asp:Button ID="btn_print" OnClick="btn_print_Click" runat="server" Text="导出快速报告" CssClass="mButton"> </asp:Button ></td>
                         <td> 
                              </td><td>
