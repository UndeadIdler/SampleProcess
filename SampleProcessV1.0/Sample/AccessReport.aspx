<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="AccessReport.aspx.cs" Inherits="Sample_AccessReport" Title="任务下达" %>
            ...
            <table class="container">
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: right" class="titleList">
                            <span style="font-size: 10pt">
                                <asp:Label ID="Label3" runat="server" Text="委托单位"></asp:Label></span>
                        </td>
                        <td class="ctrlList">
            ...
            <ContentTemplate>
                <table style="width: 800px">
                     ...
                     <tr>
                                ...
                                <td style="text-align: right; font-size: x-small;" class="titleList">
                                    <asp:Label ID="Label13" runat="server" Text="项目名称" Visible="false"></asp:Label>
                                </td>
                                <td colspan="5">
                                     <asp:TextBox ID="txt_Projectname" runat="server" Visible="false" Width="100%"></asp:TextBox>
                                </td>
                               </tr> 
                           <tr>
                            <td style="text-align: right; font-size: x-small;" class="titleList">
                    ...
                    Width="800px">
                        ...
                        <tr>
                            ...
                            <td class="titleList" style="font-size: x-small;"><span style="font-size: 10pt">
                                <asp:Label ID="lbl_ItemName" runat="server" Text="项目名称"></asp:Label>
                                </span></td>
                            <td class="ctrlList">
