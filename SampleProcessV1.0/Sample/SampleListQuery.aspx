<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="SampleListQuery.aspx.cs" Inherits="Sample_SampleListQueryOld" Title="样品列表" %>
                    ...
                    <td style=" width:115px;text-align: right" class="titleList" >
                       ...
                       <td class="Middle">
                        ...
                        <td class="ctrlList"></td>
                                ...
                                Height="21px" Width="50px"></asp:TextBox><asp:Button ID="btn_print"  CssClass="btn" runat="server" Text="导出样品编号" OnClick="btn_print_Click" /><asp:Button ID="btn_AllRemove"  CssClass="btn" runat="server" Text="移除选中项" OnClick="btn_AllRemove_Click"/><%--<input type="button" onclick="dayin()" value="打印样品列表" Visible="false" class="btn" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%></div>
