<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="ReportSign.aspx.cs" Inherits="Sample_ReportSign" Title="报告批准" %>
                        ...
                        <table class="container">
                            <tbody>
                                <tr>
                                   ...
                                   <td style="text-align: right" class="titleList">
                                        <span style="font-size: 10pt">
                               <asp:Label ID="Label95" runat="server" CssClass="mLabel" Text="审核人："></asp:Label>
                                </span>
                            </td>
                            <td class="ctrlList">
                                ...
                                <asp:Panel ID="Panel4" BackColor="#F5F9FF" runat="server" GroupingText="报告批准人填写" ForeColor="#2292DD"
                        Width="800px">
                        <table class="container">
                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <td style="text-align: right" class="titleList">
                               ...
                               <%-- <asp:Label ID="Label14" runat="server" CssClass="mLabel" Text="签发人："></asp:Label>--%>
                                </span>
                            </td>
                            <td class="ctrlList">
                               <%-- <asp:DropDownList ID="drop_user" runat="server">
                                </asp:DropDownList>--%>
                            </td>
                                ...
                                <tr>
                                    <td align="center" colspan="4">
                                        ...
                                        <asp:Button ID="Button5" OnClick="btn_BackReport_Click" runat="server" Text="回退"
                                            CssClass="mButton"></asp:Button>
                                        <asp:Button ID="Button3" OnClick="btn_SampleReport_Click" runat="server" Text="批准"
                                            CssClass="mButton"></asp:Button>
