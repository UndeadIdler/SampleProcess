<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="SampleQuery.aspx.cs" Inherits="Sample_SampleListQuery3" Title="样品列表" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>           
          <table style="border-right: 2px groove; border-top: 2px groove; border-left: 2px groove;
                                        width: 950px; border-bottom: 2px groove">
                                        <tbody>
                                            <tr>
                                                <td>
        <asp:Panel ID="Panel6" BackColor="#F5F9FF" runat="server" GroupingText="查询条件" ForeColor= "#2292DD" Width="950px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="ctrlList">
                            ...
                            <asp:TextBox ID="txt_source_query" Width="156px" runat="server" Height="21px"></asp:TextBox>
                        </td>
                        <td></td>
                     <td class="titleList" style="width:120px;text-align: right">
                            <asp:Label ID="Label4" runat="server" Text="样品原标识"></asp:Label>
                        </td>
                        <td class="ctrlList">
                            <asp:TextBox ID="txt_pfk_query" runat="server" Height="21px" Width="156px"></asp:TextBox>
                        </td><td></td>
                        <td></td>
                        ...
                        <tr>
                            ...
                            <td class="ctrlList">
                                <asp:TextBox ID="txt_WTNO_query" runat="server" Height="21px" Width="156px"></asp:TextBox>
                            </td>
                            <td></td>
                            <td></td><td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td class="ctrlList" colspan="6"  >
                            <asp:CheckBoxList ID="cbl_type" Width="600px" runat="server" Font-Size="X-Small" RepeatColumns="7" RepeatDirection="Horizontal">
                            </asp:CheckBoxList>
                        </td>
                    ...
                    <asp:Panel ID="Panel7" BackColor="#F5F9FF" runat="server" Width="950px" Height="50px"
           ...
           </asp:Panel> <div align="right"><asp:Button ID="btn_print"  CssClass="btn"  runat="server" Text="导出样品登记表" OnClick="btn_print_Click" /><%--<input type="button" onclick="dayin()" value="打印样品列表" class="btn" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>--%>
          <center><div id="dayin" style=" text-align:center">
            <asp:GridView ID="grdvw_List" runat="server" Width="950px" CssClass="mGridView"  ShowHeader="true"  OnRowCreated="grdvw_List_RowCreated">
                <Columns>
