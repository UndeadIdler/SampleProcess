<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="OutRecordlist.aspx.cs" Inherits="OutRecord_OutRecordlist" Title="外出记录" StylesheetTheme="Default" %>
                    ...
                    <tr>
                     <td style="text-align: right"><span style="font-size: 10pt"><asp:Label ID="Label6" runat="server" Text="部门"></asp:Label></span></td>
                       ...
                       <td>
                         ...
                         <td style="text-align: right"><span style="font-size: 10pt"><asp:Label ID="Label3" runat="server" Text="外出人员"></asp:Label></span></td>
                        <td class="ctrlList">
                            <asp:TextBox ID="txts_name" runat="server" Width="100px"></asp:TextBox>
                        </td>
                        <td style="text-align: right">
                            <span style="font-size: 10pt"><asp:Label ID="Label4" runat="server" Text="外出内容"></asp:Label></span>
                        </td>
            ...
            <ContentTemplate>
                <table style="width: 500px">
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label5" runat="server" Text="外出日期：" CssClass="mLabel"></asp:Label>
                            </td>
                         ...
                         <tr>
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label7" runat="server" Text="外出时段：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="width: 50px">
                            ...
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label8" runat="server" Text="外出小时数：" CssClass="mLabel"></asp:Label>
                            </td>
                        ...
                        <tr>
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label2" runat="server" Text="外出人员：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="width: 400px" colspan="5">
                                <asp:CheckBoxList runat="server" ID="cbl_UserList" RepeatColumns="5" RepeatDirection="Horizontal"></asp:CheckBoxList>
                                <%--<asp:TextBox ID="txt_name" runat="server" CssClass="mTextBox" ReadOnly="true" Width="98%"></asp:TextBox>--%>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label1" runat="server" Text="外出内容：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="width: 400px" colspan="5">
                        ...
                        <td colspan="6">
                           ...
                           <table style="width: 500px"> <tr>
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label10" runat="server" Text="是否通过：" CssClass="mLabel" Visible="false"></asp:Label>
                           </td>
                            <td style="width: 100px" class="titleList">
                                <asp:DropDownList ID="drop_flag" runat="server" Visible="false">
                                <asp:ListItem Value="1" Text="通过"></asp:ListItem>
                                <asp:ListItem Value="2" Text="未通过"></asp:ListItem>
                                </asp:DropDownList>
                                </td>
                        ...
                        <tr align="center">
                            <td class="float_Padding" colspan="7" align="center">
                                ...
                                <%-- <asp:Button ID="btn_sh" OnClick="btn_sh_Click" runat="server" Text="审核" CssClass="mButton">
                                </asp:Button>--%>
                            </td>
                        </tr>
                    </tbody>
            ...
            <ContentTemplate>
                 <table style="width: 500px">
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label12" runat="server" Text="外出日期：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="width: 400px" colspan="5">
                         ...
                         <tr>
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label13" runat="server" Text="外出时段：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="width: 50px">
                            ...
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label15" runat="server" Text="外出小时数：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="width: 100px">
                        ...
                        <tr>
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label16" runat="server" Text="外出人员：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="width: 400px" colspan="5">
                        ...
                        <tr>
                            <td style="width: 100px" class="titleList">
                                <asp:Label ID="Label17" runat="server" Text="外出内容：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td style="width: 400px" colspan="5">
