<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="OutRecordLog.aspx.cs" Inherits="OutRecordLog" Title="外出记录" %>
...
function dayin()   
{
  ...
  var newwin=window.open('',<asp:DropDownList runat="server"></asp:DropDownList>'','');
  newwin.opener = null;
  ...
  newwin.document.close();
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tbody> <tr>              
                        ...
                        <td class="querytitleList"  style="width: 350px">                            
                         ...
                         <td  width="80px" style="text-align:center;">
                           <asp:Label ID="Label3" runat="server"  Text="请选择"></asp:Label>
                        </td>
            ...
            <asp:Label ID="loglist" runat="server" Text="Label"></asp:Label><br>                 
           <%-- <div id="dayin" align="center" style="display:none;"></div> 
            <div align="center"> 
