...
namespace ZWL.BLL
{
	...
	public class ERPUser
	{
        ...
        {
            DataRow MyDataRow = DbHelperSQL.GetDataRow("select * from ERPUser where UserName='" + ProcessSqlStr(MyUserName) + "'");
            if (MyDataRow == null)
            {
            ...
            else
            {
                if (MyUserPwd == ZWL.Common.DataValidate.ValidateDataRow_S(MyDataRow, "UserPwd"))
                {
                    ...
                    {
                        System.Web.HttpContext.Current.Request.Cookies["Cookies"].Values["UserID"] = ZWL.Common.DataValidate.ValidateDataRow_S(MyDataRow, "ID");
                        System.Web.HttpContext.Current.Request.Cookies["Cookies"].Values["UserName"] = ZWL.Common.DataValidate.ValidateDataRow_S(MyDataRow, "UserName");
                        System.Web.HttpContext.Current.Request.Cookies["Cookies"].Values["JiaoSe"] = ZWL.Common.DataValidate.ValidateDataRow_S(MyDataRow, "JiaoSe");
                        System.Web.HttpContext.Current.Request.Cookies["Cookies"].Values["Department"] = ZWL.Common.DataValidate.ValidateDataRow_S(MyDataRow, "Department");
                        System.Web.HttpContext.Current.Request.Cookies["Cookies"].Values["TrueName"] = ZWL.Common.DataValidate.ValidateDataRow_S(MyDataRow, "TrueName");
                        System.Web.HttpContext.Current.Request.Cookies["Cookies"].Values["ZhiWei"] = ZWL.Common.DataValidate.ValidateDataRow_S(MyDataRow, "ZhiWei");
                        System.Web.HttpContext.Current.Request.Cookies["Cookies"].Values["QuanXian"] = ZWL.DBUtility.DbHelperSQL.GetStringList("select QuanXian from ERPJiaoSe where JiaoSeName in(" +"'"+ZWL.Common.DataValidate.ValidateDataRow_S(MyDataRow, "JiaoSe").Replace(",","','")+"'"+ ")");
                        //写登陆日志
