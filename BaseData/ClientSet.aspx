<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="ClientSet.aspx.cs" Inherits="BaseData_ClientSet" Title="Untitled Page"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label1" runat="server" Text="区域：" CssClass="mLabel" ></asp:Label>
                            </td>
                            <td class="ctrlList">
                        ...
                        <tr>
                            <td style="width: 38px" class="Middle"></td>
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label2" runat="server" Text="区域代码：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td class="ctrlList">
