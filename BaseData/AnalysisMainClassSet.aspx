<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="AnalysisMainClassSet.aspx.cs" Inherits="BaseData_AnalysisMainClassSet" Title="Untitled Page"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label1" runat="server" Text="分析项目大类名称：" CssClass="mLabel" ></asp:Label>
                            </td>
                            <td class="ctrlList">
                        ...
                        <tr>
                            <td style="width: 38px" class="Middle"></td>
                            <td style="width: 150px" class="titleList">
                                <asp:Label ID="Label2" runat="server" Text="分析项目大类代码：" CssClass="mLabel"></asp:Label>
                            </td>
                            <td class="ctrlList">
