<%@ Page Language="C#" MasterPageFile="~/QueryMasterPage.master" AutoEventWireup="true"
    CodeFile="StationInfo.aspx.cs" Inherits="BaseData_StationInfo" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="containerb">
                <tbody>
                    ...
                    <tr>
                        <td class="titleList">
                            <asp:Label ID="lbl_StationName_forSearch" runat="server" CssClass="mLabel" Text="Label">企业名称：</asp:Label>
                        </td>
                        <td>
     ...
     <div class="mLayer" style="left: 223px; top: 543px; width: 900px; height: 150px;
